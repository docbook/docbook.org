<s:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <s:pattern xmlns:dcterms="http://purl.org/dc/terms/"
              name="Only one kind of linking per element"><!-- "and" in the context is intentional --><s:rule context="db:*[@linkend and @xlink:*]">
